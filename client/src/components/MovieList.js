...
import { fetchMovieList, selectMovie, selectShowing, selectSeats } from '../actions';
...
export default withRouter(connect(mapStateToProps, { fetchMovieList, selectMovie, selectShowing, selectSeats })(MovieList));